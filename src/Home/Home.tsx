...
import client9 from "../assets/city boys.png";
...
const clients: Clients[] = [
  ...
  { id: 9, image: client9, companyName: "city boys", logoWidth: "w-full", logoHeight: "h-[100px]" },
];
  ...
  return (
    <div className="w-full bg-white flex flex-col gap-6 pb-16 sm:gap-8 sm:pb-20 lg:gap-10">
      ...
      <section id="hero" className="relative overflow-hidden" style={{ minHeight: `calc(100svh - 86px)` }}>
        ...
        <div className="relative z-10 flex min-h-[calc(100svh-86px)] w-full flex-col items-start justify-center gap-8 px-4 py-8 sm:min-h-[calc(100svh-104px)] sm:px-6 sm:py-10 md:gap-10 md:px-8 lg:min-h-[calc(100svh-136px)] lg:flex-row lg:justify-between lg:items-center lg:px-10">
          ...
          >
            ...
            `}</style>
            <div className="relative z-10 pb-4 pl-0 sm:pb-6 sm:pl-6">
              <h1 className="mt-5 text-[34px] leading-[1] tracking-normal! text-white sm:text-[54px] md:text-[60px] lg:text-[72px] xl:text-[86px]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 mt-6 w-full sm:w-auto">
                <button onClick={() => navigate(`/contact`)} className="bg-white text-[var(--primary)] px-5 md:px-6 py-3  shadow-xl font-semibold transition-all duration-300 hover:scale-105 hover:bg-[var(--primary)] hover:text-white w-full sm:w-auto">
                  Schedule an Inspection
                </button>
                <button onClick={() => navigate(`/services`)} className="bg-transparent text-white! px-5 md:px-6 py-3 shadow-xl font-semibold transition-all duration-300 hover:scale-105 hover:bg-[var(--primary)] hover:text-white w-full sm:w-auto border-2! border-white! hover:border-transparent!">
                  View Our Services
                </button>
              </div>
            </div>
          ...
          <div
            className="flex flex-row z-[900]  lg:-mt-30 lg:flex-col gap-2 sm:gap-3 md:gap-4 items-center lg:self-center"
            style={{ animation: "heroSocialIn 0.9s ease 0.5s both" }}
          >
            <button onClick={() => window.open('https://www.instagram.com/sonyah_cleaners?utm_source=qr&igsh=MWRtdG9ud3YzNDFoZQ%3D%3D', '_blank')} className="w-[43px] h-[43px] sm:w-[49px] sm:h-[49px] md:w-[52px] md:h-[52px] lg:w-[54px] lg:h-[54px]  border-[2px] lg:border-[3px] border-white flex items-center justify-center transition-all duration-300 ease-in-out hover:border-[var(--primary)] hover:bg-[var(--primary)] hover:scale-110">
            ...
            <button onClick={() => window.open('https://www.linkedin.com/company/so-nyah-integrated-ventures-limited/', '_blank')} className="w-[43px] h-[43px] sm:w-[49px] sm:h-[49px] md:w-[52px] md:h-[52px] lg:w-[54px] lg:h-[54px]  border-[2px] lg:border-[3px] border-white flex items-center justify-center transition-all duration-300 ease-in-out hover:border-[var(--primary)] hover:bg-[var(--primary)] hover:scale-110">
            ...
            <button onClick={() => window.open('https://www.youtube.com/channel/UCHM7_ihsq-vniliEXfw4-KA', '_blank')} className=" w-[43px] h-[43px] sm:w-[49px] sm:h-[49px] md:w-[52px] md:h-[52px] lg:w-[54px] lg:h-[54px]  border-[2px] lg:border-[3px] border-white flex items-center justify-center transition-all duration-300 ease-in-out hover:border-[var(--primary)] hover:bg-[var(--primary)] hover:scale-110">
              <img src={youtube} className="w-[25px] h-[25px] sm:w-[29px] sm:h-[29px] md:w-[31px] md:h-[31px] lg:w-[34px] lg:h-[34px] object-contain transition-all duration-300" />
            </button>
          </div>
        </div>
      </section>
      ...
      <section
        id="service"
        ref={serviceRef}
        className="mt-16 px-4 sm:mt-20 sm:px-6 md:px-8 lg:px-10"
      >
        <h3
          className="text-[var(--primary)] head text-[32px] sm:text-[38px] md:text-[42px] lg:text-[48px] tracking-normal!  items-center text-center"
            ...
            service && (
              ...
              >
                <div className="overflow-hidden">
                  <img src={service.heroImage} alt="service" className=" h-[260px] sm:h-[320px] md:h-[300px] lg:max-h-[360px] w-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                <div className="flex flex-row mt-3 gap-4 sm:gap-5">
                  ...
                  <div className="w-full min-w-0 gap-3 flex flex-col items-start">
                    ...
                    <CustomButton text="Read More" onClickAction={() => navigate(`/service/${service.slug}`)} />
      ...
      <section
        id="clients"
        ref={clientsRef}
        className="mt-16 w-full bg-[var(--primary)] px-4 py-10 sm:mt-20 sm:px-6 md:px-8 lg:px-10"
      >
        <h3
          className="text-white! tracking-normal! head text-[32px] sm:text-[38px] md:text-[42px] lg:text-[48px] items-center text-center"
        ...
        <div
          className="bg-white mt-10 p-4 sm:p-6 md:p-8  overflow-hidden"
      ...
      <section
        id="reviews"
        ref={reviewsRef}
        className="mt-16 px-4 sm:mt-20 sm:px-6 md:px-8 lg:px-16 xl:px-20"
      >
        <h3
          className="text-[var(--primary)] tracking-normal! head text-[32px] sm:text-[38px] md:text-[42px] lg:text-[48px] leading-[1]  items-center text-center"
      ...
      <section
        id="blog"
        ref={blogRef}
        className="mt-16 min-h-[700px] overflow-hidden px-4 sm:mt-20 sm:px-6 md:px-8 lg:px-10"
      >
        <div
            ...
            <div className="overflow-x-auto pt-6 sm:pt-8 lg:pt-10 overflow-y-visible scrollbar-hide">
              <div className="grid grid-flow-col auto-cols-[260px] sm:auto-cols-[280px] md:auto-cols-[300px] lg:auto-cols-[320px] gap-6 lg:gap-10 bg-transparent">
                ...
                {!postsLoading && livePosts.map((article, idx) => (
                  ...
                  >
<<<<<<< HEAD
                    <div className="w-full h-[290px] md:h-[490px] overflow-hidden bg-gray-100">
=======
...
>>>>>>> 16c80a74640db8449e755433c41774f07b3a18a7
            ...
            <>
              <div className="overflow-x-auto pt-6 sm:pt-8 lg:pt-10 scrollbar-hide">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8">
                  {[
                    ...
                    { type: "single", image: before, title: "Interior Space Care" },
                    { type: "single", image: after2, title: "Interior Space Care" },
                    { type: "single", image: after, title: "Interior Space Care" },
              ...
              {expandedGalleryItem && (
                <div className="fixed inset-0 z-[2000] bg-black/80 flex items-center justify-center p-4 sm:p-6" onClick={() => setExpandedGalleryItem(null)}>
                  <div className="relative bg-white  max-w-6xl w-full max-h-[90vh] overflow-auto p-4 sm:p-6" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="fixed z-[800] bottom-4 sm:bottom-6 md:bottom-8 lg:bottom-10 right-4 sm:right-6 md:right-8 lg:right-10 flex flex-col items-end gap-3">
        ...
        <button onClick={() => window.open("https://wa.me/message/CXGU4I2ZUXS4I1", "_blank")} className="relative  flex px-4 sm:px-5 md:px-5 lg:px-6 shadow-xl rounded-3xl text-white bg-[var(--text-sub-h)] py-3 items-center gap-2 sm:gap-3 text-sm sm:text-base transition-all duration-300 hover:scale-105 hover:shadow-2xl">
