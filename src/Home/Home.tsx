              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 mt-6 w-full sm:w-auto">
                  <button 
                    ...
                    className="bg-white text-[var(--primary)] px-5 py-3 rounded-2xl shadow-xl font-semibold transition-all duration-300 hover:scale-105 hover:bg-[var(--primary)] hover:text-white w-full sm:w-auto  "> 
                  ...
                  <button 
                    onClick={()=> navivgate(`/services`)}  
                     className="bg-transparent   text-white! px-5 py-3 rounded-2xl shadow-xl font-semibold transition-all duration-300 hover:scale-105 hover:bg-[var(--primary)] hover:text-white w-full sm:w-auto  border-2!  border-white! hover:border-transparent!">
                    View Our Services
                  </button>
                </div>
              </div>
          ...
          <div className="flex flex-nowrap items-center justify-between gap-3 whitespace-nowrap w-full">
            <div className="flex flex-nowrap gap-2 sm:gap-3 whitespace-nowrap">
              <button
                ...
                className={`shrink-0 px-4 sm:px-5 min-w-[40px] sm:min-w-[50px] lg:min-w-[200px] py-3 rounded-3xl font-semibold transition-all duration-300 hover:scale-105 whitespace-nowrap text-[16px] sm:text-[20px] lg:text-[24px] xl:text-[30px] leading-[1] ${
                  isBlogGallery === "Blog"
                    ? "bg-[var(--primary)] !text-white"
            ...
            <button onClick={()=> { isBlogGallery == "Blog" ? navivgate("/blog") : alert("Still working on the gallery page")}} className="flex flex-row items-center justify-between gap-3 shrink-0 whitespace-nowrap ml-2">
          ...
          <div className="pt-3">
            {isBlogGallery === "Blog" && (
              <div className="overflow-x-auto pt-6 sm:pt-8 lg:pt-10 overflow-y-visible scrollbar-hide">
                <div className="grid grid-flow-col auto-cols-[260px] sm:auto-cols-[280px] lg:auto-cols-[320px] gap-6 lg:gap-10 bg-transparent">
            ...
            {isBlogGallery === "Gallery" && (
              <>
                <div className="overflow-x-auto pt-6 sm:pt-8 lg:pt-10 scrollbar-hide">
                  <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 grid-rows-2 md:grid-rows-2 gap-6 lg:gap-8">
                    {[
                      {
                        type: "before-after",
                        before: before,
